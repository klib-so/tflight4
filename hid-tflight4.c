...
#define USB_DEVICE_ID_THRUSTMASTER_TFLIGHT4_CONTROLLER 0xb67b
#define USB_DEVICE_ID_THRUSTMASTER_TFLIGHT4_JOYSTICK 0xb67c
...
static const struct hid_device_id tflight_devices[] = {
    { HID_USB_DEVICE(USB_VENDOR_ID_THRUSTMASTER, USB_DEVICE_ID_THRUSTMASTER_TFLIGHT4_CONTROLLER)},
     {HID_USB_DEVICE(USB_VENDOR_ID_THRUSTMASTER, USB_DEVICE_ID_THRUSTMASTER_TFLIGHT4_JOYSTICK)},
    { }
};
